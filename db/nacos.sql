...
INSERT INTO `config_info` VALUES (14, 'logging.yml', 'DEFAULT_GROUP', 'logging:\r\n  level:\r\n    root: info\r\n  pattern:\r\n    file: \'%d{yyyy-MM-dd HH:mm:ss.SSS} %-5level [%thread] %F.%M - %msg%n\'\r\n    console: \'%d{yyyy-MM-dd HH:mm:ss.SSS} %-5level [%thread] %F.%M - %msg%n\'\r\n  file:\r\n    path: logs\r\n    name: ${logging.file.path}/${spring.application.name}/root.log\r\n  logback:\r\n    rollingpolicy:\r\n      max-file-size: 50MB\r\n      max-history: 7', 'e35a48706c2ba165750cdcf341c47cfe', '2023-01-26 19:50:52', '2023-01-26 19:50:52', NULL, '0:0:0:0:0:0:0:1', '', 'dev', NULL, NULL, NULL, 'yaml', NULL, '');
...
INSERT INTO `config_info` VALUES (33, 'mybatis-plus.yml', 'DEFAULT_GROUP', 'mybatis-plus:\r\n  global-config:\r\n    db-config:\r\n      logic-delete-field: delFlag\r\n      logic-delete-value: 1 # 逻辑已删除值(默认为 1)\r\n      logic-not-delete-value: 0 # 逻辑未删除值(默认为 0)\r\n      select-strategy: not_empty # 空字符查询\r\n  mapper-locations: classpath*:com/quick/modules/**/xml/*Mapper.xml', '70f5291388f60ec752ffc96dcd56f0d7', '2023-04-22 07:26:42', '2023-04-22 07:26:42', NULL, '0:0:0:0:0:0:0:1', '', 'dev', NULL, NULL, NULL, 'yaml', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (0, 32, 'knife4j.yml', 'DEFAULT_GROUP', '', 'springdoc:\r\n  swagger-ui:\r\n    path: /swagger-ui.html\r\n    tags-sorter: alpha\r\n    operations-sorter: alpha\r\n  api-docs:\r\n    path: /v3/api-docs\r\n  group-configs:\r\n    - group: \'default\'\r\n      paths-to-match: \'/**\'\r\n      packages-to-scan: com.quick.modules\r\n\r\nknife4j:\r\n  enable: true\r\n  setting:\r\n    language: zh_cn\r\n    swagger-model-name: 实体类列表', 'd970aff43ea49736709338c0a7bd0cac', '2023-04-22 15:25:54', '2023-04-22 07:25:55', NULL, '0:0:0:0:0:0:0:1', 'I', 'dev', '');
INSERT INTO `his_config_info` VALUES (0, 33, 'mybatis-plus.yml', 'DEFAULT_GROUP', '', 'mybatis-plus:\r\n  global-config:\r\n    db-config:\r\n      logic-delete-field: delFlag\r\n      logic-delete-value: 1 # 逻辑已删除值(默认为 1)\r\n      logic-not-delete-value: 0 # 逻辑未删除值(默认为 0)\r\n      select-strategy: not_empty # 空字符查询\r\n  mapper-locations: classpath*:com/quick/modules/**/xml/*Mapper.xml', '70f5291388f60ec752ffc96dcd56f0d7', '2023-04-22 15:26:41', '2023-04-22 07:26:42', NULL, '0:0:0:0:0:0:0:1', 'I', 'dev', '');
INSERT INTO `his_config_info` VALUES (6, 34, 'quick-boot-system-biz.yml', 'DEFAULT_GROUP', '', 'server:\n  port: 8080\n\nspring:\n  datasource:\n    dynamic:\n      primary: master #设置默认的数据源或者数据源组,默认值即为master\n      strict: false #严格匹配数据源,默认false. true未匹配到指定数据源时抛异常,false使用默认数据源\n      datasource:\n        master:\n          url: jdbc:p6spy:mysql://127.0.0.1:3306/quick-boot\n          username: root\n          password: 123456\n          driver-class-name: com.p6spy.engine.spy.P6SpyDriver\n\nspringdoc:\n  swagger-ui:\n    path: /swagger-ui.html\n    tags-sorter: alpha\n    operations-sorter: alpha\n  api-docs:\n    path: /v3/api-docs\n  group-configs:\n    - group: \'default\'\n      paths-to-match: \'/**\'\n      packages-to-scan: com.quick.modules\n\nknife4j:\n  enable: true\n  setting:\n    language: zh_cn\n    swagger-model-name: 实体类列表\n\nmybatis-plus:\n  global-config:\n    db-config:\n      logic-delete-field: delFlag\n      logic-delete-value: 1 # 逻辑已删除值(默认为 1)\n      logic-not-delete-value: 0 # 逻辑未删除值(默认为 0)\n      select-strategy: not_empty # 空字符查询\n  mapper-locations: classpath*:com/quick/modules/**/xml/*Mapper.xml\n', 'fd698ea0b635c36936a150c98d3c6fdb', '2023-04-22 15:31:33', '2023-04-22 07:31:34', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'dev', '');
INSERT INTO `his_config_info` VALUES (3, 35, 'quick-boot-oauth2-biz.yml', 'DEFAULT_GROUP', '', 'server:\n  port: 8082\n\n\nspringdoc:\n  swagger-ui:\n    path: /swagger-ui.html\n    tags-sorter: alpha\n    operations-sorter: alpha\n  api-docs:\n    path: /v3/api-docs\n  group-configs:\n    - group: \'default\'\n      paths-to-match: \'/**\'\n      packages-to-scan: com.quick.modules\n\nknife4j:\n  enable: true\n  setting:\n    language: zh_cn\n    swagger-model-name: 实体类列表\n', '80f220967a39cfe2e72a8e7298566b39', '2023-04-22 15:31:51', '2023-04-22 07:31:51', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'dev', '');
INSERT INTO `his_config_info` VALUES (5, 36, 'sa-token.yml', 'DEFAULT_GROUP', '', 'sa-token:\n  oauth2:\n    is-code: true\n    is-implicit: true\n    is-password: true\n    is-client: true\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: -1\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: random-64\n  # 是否输出操作日志\n  is-log: false', '17d211c8e521e2f3085c4e4b6ef67f14', '2023-04-22 22:46:16', '2023-04-22 14:46:16', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'dev', '');
INSERT INTO `his_config_info` VALUES (4, 37, 'redis.yml', 'DEFAULT_GROUP', '', 'spring:\r\n  data:\r\n    redis:\r\n      host: 127.0.0.1\r\n      port: 6379\r\n      password: 123456', 'b70983a8f9caa431430f54f2c72d8908', '2023-05-04 16:11:06', '2023-05-04 08:11:06', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'dev', '');

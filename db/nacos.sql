...
) ENGINE = InnoDB AUTO_INCREMENT = 83 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = 'config_info' ROW_FORMAT = Dynamic;
...
INSERT INTO `config_info` VALUES (79, 'quick-boot-flow.yml', 'DEFAULT_GROUP', 'server:\r\n  port: 8084\r\n\r\nspring:\r\n  datasource:\r\n    dynamic:\r\n      primary: master #设置默认的数据源或者数据源组,默认值即为master\r\n      strict: false #严格匹配数据源,默认false. true未匹配到指定数据源时抛异常,false使用默认数据源\r\n      datasource:\r\n        master:\r\n          url: ${mysql-server.address}/quick-boot-flow\r\n          username: ${mysql-server.username}\r\n          password: ${mysql-server.password}\r\n          driver-class-name: ${mysql-server.driver-class-name}', '1fc4e318303b9882b17d2c61c609b017', '2024-01-07 13:02:09', '2024-01-07 13:02:09', NULL, '0:0:0:0:0:0:0:1', '', 'dev', NULL, NULL, NULL, 'text', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 88 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;

...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = 'config_info' ROW_FORMAT = Dynamic;
...
INSERT INTO `config_info` VALUES (4, 'redis.yml', 'DEFAULT_GROUP', 'spring:\r\n  data:\r\n    redis:\r\n      host: 127.0.0.1\r\n      port: 6379\r\n      password: 123456', 'b70983a8f9caa431430f54f2c72d8908', '2023-01-24 16:49:35', '2023-01-24 16:49:35', NULL, '0:0:0:0:0:0:0:1', '', 'dev', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (5, 'sa-token.yml', 'DEFAULT_GROUP', 'sa-token:\n  oauth2:\n    is-code: true\n    is-implicit: true\n    is-password: true\n    is-client: true\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: -1\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: random-64\n  # 是否输出操作日志\n  is-log: false', '17d211c8e521e2f3085c4e4b6ef67f14', '2023-01-24 16:53:20', '2023-02-21 13:52:43', 'nacos', '0:0:0:0:0:0:0:1', '', 'dev', '', '', '', 'yaml', '', '');
...
-- ----------------------------
INSERT INTO `his_config_info` VALUES (6, 31, 'quick-boot-system-biz.yml', 'DEFAULT_GROUP', '', 'server:\n  port: 8080\n\nspring:\n  datasource:\n    dynamic:\n      primary: master #设置默认的数据源或者数据源组,默认值即为master\n      strict: false #严格匹配数据源,默认false. true未匹配到指定数据源时抛异常,false使用默认数据源\n      datasource:\n        master:\n          url: jdbc:p6spy:mysql://127.0.0.1:3306/quick-boot\n          username: root\n          password: 123456\n          driver-class-name: com.p6spy.engine.spy.P6SpyDriver\n\nspringdoc:\n  swagger-ui:\n    path: /swagger-ui.html\n    tags-sorter: alpha\n    operations-sorter: alpha\n  api-docs:\n    path: /v3/api-docs\n  group-configs:\n    - group: \'default\'\n      paths-to-match: \'/**\'\n      packages-to-scan: com.quick.modules\n\nknife4j:\n  enable: true\n  setting:\n    language: zh_cn\n    swagger-model-name: 实体类列表\n\nmybatis-plus:\n  global-config:\n    db-config:\n      logic-delete-field: delFlag\n      logic-delete-value: 1 # 逻辑已删除值(默认为 1)\n      logic-not-delete-value: 0 # 逻辑未删除值(默认为 0)\n  mapper-locations: classpath*:com/quick/modules/**/xml/*Mapper.xml\n', '4a491547dc5b53d0950a18b2e623859f', '2023-04-01 13:22:36', '2023-04-01 05:22:37', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'dev', '');

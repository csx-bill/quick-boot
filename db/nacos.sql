...
) ENGINE = InnoDB AUTO_INCREMENT = 108 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = 'config_info' ROW_FORMAT = Dynamic;
...
INSERT INTO `config_info` VALUES (5, 'sa-token.yml', 'DEFAULT_GROUP', 'sa-token:\n  oauth2:\n    is-code: true\n    is-implicit: true\n    is-password: true\n    is-client: true\n  # token名称 (同时也是cookie名称)\n  token-name: X-Access-Token\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  active-timeout: -1\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: false\n  # token风格\n  token-style: random-64\n  # 是否输出操作日志\n  is-log: false', '385215926108a9ea017cce4842ef9dec', '2023-01-24 16:53:20', '2024-02-05 14:32:50', 'nacos', '0:0:0:0:0:0:0:1', '', 'dev', '', '', '', 'yaml', '', '');
...
INSERT INTO `his_config_info` VALUES (5, 112, 'sa-token.yml', 'DEFAULT_GROUP', '', 'sa-token:\n  oauth2:\n    is-code: true\n    is-implicit: true\n    is-password: true\n    is-client: true\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  active-timeout: -1\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: false\n  # token风格\n  token-style: random-64\n  # 是否输出操作日志\n  is-log: false', 'd03abd3bae1b56ecd7ff53f876720f54', '2024-02-05 22:32:49', '2024-02-05 14:32:50', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'dev', '');

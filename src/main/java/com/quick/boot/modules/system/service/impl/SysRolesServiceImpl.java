...
import com.quick.boot.modules.system.mapper.SysRoleMenuMapper;
import com.quick.boot.modules.system.mapper.SysRolesMapper;
...
public class SysRolesServiceImpl extends ServiceImpl<SysRolesMapper, SysRoles> implements SysRolesService {
     ...
     */
    @Override
    public List<SysRoles> getUserRoles() {

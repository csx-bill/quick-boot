package com.quick.flow.engine.engine;


import com.quick.flow.engine.param.*;
...
public interface ProcessEngine {
     ...
     * Start process
     * <p>
     * 1.Create a flow instance({@link com.quick.flow.engine.entity.FlowInstancePO}) according to the specified

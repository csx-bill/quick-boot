...
import static com.quick.flow.engine.common.Constants.CALL_ACTIVITY_EXECUTE_TYPE.ASYNC;
import static com.quick.flow.engine.common.Constants.CALL_ACTIVITY_EXECUTE_TYPE.SYNC;
import static com.quick.flow.engine.common.Constants.CALL_ACTIVITY_INSTANCE_TYPE.MULTIPLE;
import static com.quick.flow.engine.common.Constants.CALL_ACTIVITY_INSTANCE_TYPE.SINGLE;
import static com.quick.flow.engine.common.Constants.ELEMENT_PROPERTIES.*;
...
public class CallActivityValidator extends ElementValidator {
    ...
    private int getNestedLevel(FlowElement rootFlowElement, FlowElement flowElement, Map<String, Integer> flowModuleId2NestLevelCache) throws DefinitionException {
        ...
        FlowDefinition flowDefinition = flowDefinitionService.selectByFlowModuleId(callActivityFlowModuleId);
